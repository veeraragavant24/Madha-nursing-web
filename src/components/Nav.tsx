...
@media (min-width: 769px) and (max-width: 1400px) {
  ...
  /* =======================================================
     LAPTOP TITLE
     (font size reduced — was clamp(17px, 1.45vw, 22px))
     ======================================================= */
  .nav-root.transparent .nav-college-name,
  .nav-root.solid .nav-college-name {
    font-size: clamp(14px, 1.1vw, 18px) !important;
    letter-spacing: clamp(.025em, .06vw, .045em) !important;
  }

  /* =======================================================
     LAPTOP GOLD RIBBON
     GOLD RIBBON + MOVING WHITE SHINE + CENTER DIAMOND
     (height increased — was 7px)
     ======================================================= */
  .premium-divider {
    position: relative !important;
    ...
    */
    ...
    /*
      GOLD STAYS FIXED
      SHINE STARTS AT THE LEFT EDGE OF THE RIBBON (M of MADHA)
    */
    background-position:
      center center,
      0% center !important;
  ...
  /* =======================================================
     ...
     STARTS AT M OF MADHA → ENDS AT G OF NURSING
     Applies to BOTH .nav-root.transparent and .nav-root.solid
     since .premium-divider is not state-scoped.
     ======================================================= */
  @keyframes laptopGoldRibbonShine {

    /* Start at the M side of MADHA (left edge of ribbon) */
    0% {
      background-position:
        center center,
        0% center !important;
    ...
    /* End at the G side of NURSING (right edge of ribbon) */
    100% {
      background-position:
        center center,
  ...
  /* =======================================================
     MENU SIZE
     (font size reduced — was clamp(12px, .68vw, 15px))
     ======================================================= */
  .nav-root.transparent .nav-item,
  .nav-root.solid .nav-item {
    font-size: clamp(11px, .55vw, 13px) !important;
  }
  ...
  /* =======================================================
     APPLY NOW — TRANSPARENT
     (font size reduced — was 12px)
     ======================================================= */
  .nav-root.transparent .btn-apply {
  ...
  /* =======================================================
     SOLID RIBBON
     (height increased — was 4px; animation inherited from
     the base .premium-divider rule above, so the shine
     moves the same way on the white/solid header too)
     ======================================================= */
  .nav-root.solid .premium-divider {
    width: clamp(165px, 15vw, 205px) !important;
...
/* =========================================================
   ...
   OUTSIDE MEDIA QUERY
   (kept as-is from original file — not part of the requested
   change, left untouched in case it's used elsewhere)
   ========================================================= */
...
@media (max-width: 480px) {
  ...
  .top-contact-inner .top-contact-item(2) {
    display: none !important;
  }
  .top-contact-inner .top-address {
    margin-left: auto !important;
