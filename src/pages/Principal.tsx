      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'radial-gradient(circle at 70% 60%, rgba(24,198,200,.08) 0%, transparent 55%)',
            pointerEvents: 'none',
          }}
        />
        ...
        <div className="principal-hero-grid">
          ...
          <div className="principal-hero-content">
            ...
            >
              Principal, Madha College of Nursing
            </div>
            ...
            <div className="principal-achievements">
              {ACHIEVEMENTS.map((a) => (
                ...
                >
                  <div
                    className="font-sans text-gold-g"
                    style={{
                      fontSize: 32,
                      fontWeight: 700,
                      letterSpacing: '-.02em',
            ...
            <div>
              <Reveal type="right">
                ...
                >
                  {/* Quote mark */}
                  <div
                    className="font-sans principal-quote"
                    style={{
                      fontSize: 80,
                      color: '#18C6C8',
                      lineHeight: 0.8,
                  ...
                  >
                    <div
                      className="principal-signature-avatar"
                      style={{
                        width: 56,
                        height: 56,
                        borderRadius: 16,
                        background:
                          'linear-gradient(135deg, #0B2545, #18C6C8)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        flexShrink: 0,
