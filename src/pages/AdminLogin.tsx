    ...
    <div className="admin-login-page">
      <style>{`
        ...
        .admin-login-btn {
          ...
          letter-spacing: .03em;
          box-shadow:
            0 14px 30px rgba(24,198,200,.35);
          transition:
        ...
        .admin-login-btn:hover:not(:disabled) {
          ...
          box-shadow:
            0 18px 36px rgba(24,198,200,.45);
        }
        ...
        .admin-login-spinner {
          ...
          border-radius: 50%;
          animation:
            admin-login-rotate .7s linear infinite;
          vertical-align: -3px;
        }
        ...
        .admin-login-back:hover:not(:disabled) {
          color: #0B2545;
        }

        .admin-login-back:disabled {
          opacity: .7;
          cursor: not-allowed;
        }
